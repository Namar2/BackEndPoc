 ...
 *
 * Sample core.data insertion code is commented out for demonstration purposes.
 * Uncomment it if you want to insert initial core.data into the Users table when setting up the database.
 */
fun setupDatabase() {
    initDatabase()
    transaction {
